...
<div class="header" id="head">	
         ...
         <div class="header-top">
		   ...
		   <div class="top-menu">
			...
			<ul>
				...
				<li><a href="#about" class="scroll"><span data-hover="book">book</span></a></li>
				...
				<li><a href="login.php"><span data-hover="logout"> LogOut</span></a></li>
				</nav>
			 </ul>
			 </div>
			 <!--script-nav-->
	...
	<div class="content"><div class="about-section" id="about" id="about">
	<div class="container">
    ...
    <div class="col-md-6">
      <div class="thumbnail" style="padding-left: 100px;  padding-right: 100px;">
        <a href="registration.php" target="_blank">
          <img src="getride.jpg" width="500px" height="300px">
          <div class="caption">
            <p><center><button type="button" class="btn btn-primary btn-block btn-lg">Offer a ride</button></center></p>
          </div>
        </a>
      </div>
    </div>
    <div class="col-md-6">
      <div class="thumbnail " style="padding-left: 100px;  padding-right: 100px;">
        <a href="reservation.php" target="_blank">
          <img src="bg.jpg" alt="Nature" width="500px" height="300px" >
          <div class="caption">
            <p><center><button type="button" class="btn btn-primary btn-block btn-lg">Find a ride</button></center></p>
          </div>
        </a>
      </div>
    </div>
...
<div class="works-header">
			<h3>works</h3>
				<p>Providing the best experience that every rider deserves... </p>
		</div>
	...
	<div class="services-section" id="services">
			...
			<div class="services-header">
				<h3>services</h3>
					<p>Providing riding services that helps both the riders and the consumers providing the best facilities. We offer best safety even in COVID pandemic.  </p>
			</div>
			<div class="services-sectiongrids">
				<div class="col-md-4 services-grid">
					<img src="images/img1.png" alt=""/>
					<h4>Real time Monitoring</h4>
					<p>We will look over you to keep you SAFE.</p>
				</div>
				<div class="col-md-4 services-grid">
					<img src="images/img2.png" alt=""/>
					<h4>INVOICE FOR EACH JOURNEY</h4>
					<p>Pay only for what you use</p>
				</div>
				<div class="col-md-4 services-grid">
					<img src="images/img3.png" alt=""/>
					<h4>SAFE JOURNEY</h4><p>No Worries !! We are with you</p>
					<!--  -->
				</div>
				<div class="clearfix"></div>
				<div class="arrow1">
	...
	<div class="footer-section" id="contact" id="contact">
			...
			<div class="footer-bottom">
					...
					<p>&copy; 2021 Thiagraarajar College of Engineering . All rights  Reserved | Template by<a href="#" target="target_blank">Team AT6</a></p>
